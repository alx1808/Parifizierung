...
namespace AcadPari
{
    public class BlockReader
    {
        ...
        private void FixBegrundungValue()
        {
            ...
            {
                if (IsChangeToWohnungseigentumsobjektBegrundung(blockInfo))
                {
        ...
        private void WidmungNutzwertBegrundungCorrection()
        {
            ...
            foreach (var blockInfo in _blockInfos)
            {
                ...
                {
                    blockInfo.Widmung = "";
                    blockInfo.Nutzwert = "1,00"; // eigentlich nicht notwendig, da nutzwert für allgemein nicht verwendet wird (in nw)
                    continue;
                }
